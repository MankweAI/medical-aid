...
export const PERSONAS: Persona[] = [
    {
        ...
        actuarial_logic: {
            ...
            ui_hooks: {
                simple_verdict: "This plan is great for families with ADHD. It helps pay for expensive daily meds that many other plans don't cover.",
                the_catch_simple: "There is a limit of R16,827 for the whole family's meds. If you use a lot of medicine, you might have to pay yourself later in the year.",
                pressing_questions: [
                    {
                        question: "Is R16,827 enough for my family's ADHD meds?",
                        context_for_expert: "User is managing ADHD for multiple children. Plan has a R16,827 Non-CDL limit and a 25% co-pay on non-formulary brands."
                    },
                    {
                        question: "How do I avoid the 25% extra medicine cost?",
                        context_for_expert: "User needs to know which ADHD brands are on the Bestmed formulary to avoid the 25% co-payment."
                    },
                    {
                        question: "What happens if we reach the limit in June?",
                        context_for_expert: "User is worried about out-of-pocket costs once the annual Non-CDL limit is exhausted."
                    }
                ]
            }
        }
