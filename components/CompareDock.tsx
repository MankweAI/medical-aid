                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-xs font-bold text-white">
                            Compare <span className="text-blue-400">({selectedPlans.length}/2)</span>
                        </p>
                        <p className="text-[10px] text-slate-400">
                            {selectedPlans.length === 1 ? "Select 1 more to battle" : "Ready to analyze"}
                        </p>
                    </div>
                </div>

                <div className="flex items-center gap-2">
                    <button onClick={clearSelection} className="p-2 text-slate-400 hover:text-white transition-colors">
                        <X className="w-4 h-4" />
                    </button>
                    <Link
