        ...
        >
            ...
            <div className="p-4">
                ...
                <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="text-right pr-8"> {/* Added padding right to avoid overlap with Pin button */}
                ...
                <div className="space-y-4">
                    ...
                    {/* 1. COVERAGE RATES (Redesigned Minimalist Tag) */}
                    ...
                    <button
                        ...
                        className="w-full bg-slate-900 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-slate-900/20 flex items-center justify-center gap-2 active:scale-95 transition-transform mt-2"
                    >
                        Verify this Strategy <ArrowRight className="w-4 h-4" />
                    </button>
                </div>
            </div>
        </div>
