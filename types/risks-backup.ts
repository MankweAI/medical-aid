...
export interface Procedure {
    ...
    // NEW: Accurate Coding Structure
    cpt_code: string; // The Procedure Code (e.g. 43235) - Fixed per procedure

    // SEO Content Booster: List of common reasons for this test
    common_diagnoses: {
        code: string; // ICD-10 Code (e.g. "K21.9")
        label: string; // (e.g. "Gastro-oesophageal reflux disease")
    }[];
